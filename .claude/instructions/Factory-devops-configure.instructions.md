...
> Detailed instructions for infrastructure plan creation (`--configure`), approval (`--approve`), refinement (`--refine`), every guardrail (-1 to 7, Beat 0 at 0.5), and the RDR Persistence Loop.
