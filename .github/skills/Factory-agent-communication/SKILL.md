...
**Problem:** Sub-agents are `user-invokable: false` and operate via handoffs. Without explicit communication, the user sees only collapsed tool calls and has no visibility into agent transitions, progress, or results.

---

## 1. Entry Announcement (MANDATORY — First message after handoff)
...
## 3. Completion Summary (MANDATORY — Last message before handoff return)
