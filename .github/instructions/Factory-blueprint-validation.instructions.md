...
Cross-artifact coherence validation between CODESIGN and BLUEPRINT deliverables. See `.github/skills/Factory-coherence-validation/SKILL.md` for full protocol.
...
### Downstream Cascade Invalidation (v10.0.0)
...
6. **Incremental Persistence (IPP)**: Follow `.github/skills/Factory-incremental-persistence/SKILL.md` — skeleton-first write, section-atomic saves, resume-on-entry. See `blueprint-design.md` for BLUEPRINT-specific IPP implementation.
