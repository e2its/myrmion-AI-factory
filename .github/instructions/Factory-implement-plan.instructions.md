...
Cross-artifact coherence validation across the CODESIGN↔BLUEPRINT↔IMPLEMENT chain. See `.github/skills/Factory-coherence-validation/SKILL.md` for full protocol.
