...
> **Implements:** Incremental Persistence Protocol (`.github/skills/Factory-incremental-persistence/SKILL.md`) — Pillar 2 (Section-Atomic Saves).
...
> This file enables post-summarization governance recovery (see `.github/skills/Factory-governance-loading/SKILL.md` Step 0).
...
```
This ensures that even operations outside `@Factory` are blocked from committing directly to `main`.
...
> **Implements:** Incremental Persistence Protocol (`.github/skills/Factory-incremental-persistence/SKILL.md`) — Pillar 3 (Resume-on-Entry).
