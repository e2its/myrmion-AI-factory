...
|---|---|
| .github/instructions/agents/*.md | .github/instructions/Factory-*.instructions.md |
| .github/instructions/protocols/*.md | .github/instructions/Factory-protocol-*.instructions.md |
| .github/instructions/protocols/{5 cross-cutting}.md | .github/skills/Factory-{name}/SKILL.md |
