...
for script in auto-tag.sh install-hooks.sh security-scan.sh validate-governance.sh governance-onprompt.sh governance-oncompact.sh governance-onedit.sh generate-governance-snapshot.sh check-inventory-drift.sh project_summarization.py check-adr-constitution-sync.sh; do
